...
function preload(){
  ...
  mainRacerImg1 = loadAnimation("images/mainPlayer[1].png","images/mainPlayer[2].png");
  mainRacerImg2 = loadAnimation("images/mainPlayer[3].png");
  
  pinkRacerImg1 = loadAnimation("images/opponent1[1].png","images/opponent1[2].png");
  pinkRacerImg2 = loadAnimation("images/opponent1[3].png");
  
  redRacerImg1 = loadAnimation("images/opponent2[1].png","images/opponent2[2].png");
  redRacerImg2 = loadAnimation("images/opponent2[3].png");
  
  yellowRacerImg1 = loadAnimation("images/opponent3[1].png","images/opponent3[2].png");
  yellowRacerImg2 = loadAnimation("images/opponent3[3].png");
